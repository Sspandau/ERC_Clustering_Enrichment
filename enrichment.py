...
@click.option('--clustering_type', default='cluster', help="Indicate whether enrichment is for clusters or subclusters")
@click.option('--Filter', is_flag=True, help="Indicate whether to filter for top result in each cluster")


df1 = pd.read_csv(cluster_csv)
